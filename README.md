...
## Models included
- **R1 (doomed):** real CNN on magnitude only |z|
- **R2 (real-fair):** real CNN on (cos θ, sin θ) (+ optional amplitude channel)
- **C1 (complex):** complex CNN using complex convolutions + modReLU, trained on complex input z
